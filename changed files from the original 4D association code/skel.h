...
inline const SkelDef& GetSkelDef(const SkelType& type)
{
	static const std::vector<SkelDef> skelDefs = [] {
		...
		// PAN17
		_skelDefs[PAN17].jointSize = 17;
		_skelDefs[PAN17].pafSize = 17;
		_skelDefs[PAN17].pafDict.resize(2, 17);
		_skelDefs[PAN17].pafDict << 1, 0, 0, 9, 3, 2, 2, 12, 6, 13, 7, 9, 3, 10, 4, 16, 15,
			0, 9, 3, 12, 6, 12, 6, 13, 7, 14, 8, 10, 4, 11, 5, 1, 1;
		_skelDefs[PAN17].drawBone.resize(2, 17);
		_skelDefs[PAN17].drawBone << 1, 0, 0, 9, 3, 2, 2, 12, 6, 13, 7, 9, 3, 10, 4, 16, 15,
			0, 9, 3, 12, 6, 12, 6, 13, 7, 14, 8, 10, 4, 11, 5, 1, 1;
